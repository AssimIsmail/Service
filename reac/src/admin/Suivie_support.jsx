...
const Suivie_support = () => {
  ...
  return (
    <div>
      <Navbar />
      <h1 className="text-2xl font-bold text-center my-4">Mes Reclamation</h1>
      ...
      <Link to={`/Support_page`} className="mt-4 inline-block px-4 py-2 rounded text-gray  transition-colors duration-300">
