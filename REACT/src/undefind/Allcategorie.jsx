  ...
  return (
    <div className="container mx-auto">
      <div className="flex items-center justify-center space-x-4">
        <button
          onClick={handlePrev}
          disabled={startIndex === 0} // Désactive le bouton si nous sommes au début de la liste
          ...
          {visibleCategories.map((category) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${
                    category.image ? category.image : "default-image-path.jpg"
                  })`,
                }}
              ></div>
              <div className="p-4">
        ...
        <button
          onClick={handleNext}
          disabled={startIndex + 4 >= categories.length} // Désactive le bouton si nous sommes à la fin de la liste
